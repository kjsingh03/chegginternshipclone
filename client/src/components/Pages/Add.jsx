    ...
    const submit = (e) => {
        ...
        if (image) {
            ...
            axios.post("https://api.cloudinary.com/v1_1/dwrwxeoih/image/upload", data)
                .then(res => {
                    axios.post(`${import.meta.env.VITE_API_KEY}/api/internship`, { ...form, skills: newSkills, perks: newPerks, questions: newQuestion, lessons: [...newLessons], imageUrl: res.data.secure_url }, {
                        headers: {
            ...
            axios.post(`${import.meta.env.VITE_API_KEY}/api/internship`, { ...form, skills: newSkills, perks: newPerks, questions: newQuestion, lessons: [...newLessons]}, {
                headers: {
                    "Authorization": user?.token,
                    "Content-Type": "application/json"
                }
