    ...
    return (
        <>
            ...
            <div className='min-h-screen flex flex-col gap-6 w-[90%] sm:w-[50%] md:w-[40%] xl:w-[30%] mx-auto py-12 shadow-lg pt-[8rem]'>
                ...
                <input type="text" name="name" onChange={handleChange} placeholder="Enter name" className='border-2 rounded-xl border-slate-300 outline-[#EB7100] p-3' />
                ...
                <input type="text" name="college" onChange={handleChange} placeholder="Enter college" className='border-2 rounded-xl border-slate-300 outline-[#EB7100] p-3' />
                <input type="text" name="address" onChange={handleChange} placeholder="Enter address" className='border-2 rounded-xl border-slate-300 outline-[#EB7100] p-3' />
                <input type="number" name="contact" onChange={handleChange} placeholder="Enter contact (whatsapp)" className='border-2 rounded-xl border-slate-300 outline-[#EB7100] p-3' />
