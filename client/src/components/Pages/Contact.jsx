    ...
    return (
        <>
            ...
            <div className="w-full xl:w-[95%] min-h-[100vh] mx-auto text-center flex flex-col items-center px-3 sm:px-0 gap-6 lg:gap-12 pb-[5rem] pt-[8rem]">
                ...
                <p className="text-sm lg:text-lg font-medium w-full sm:w-[60%] mx-auto">Have a question, suggestion, or just want to get in touch? We'd love to hear from you! Please use the contact form below to reach out to our team.</p>
                ...
                <p className="text-sm lg:text-lg font-medium w-full sm:w-[60%] mx-auto">If you prefer, you can also reach us via email at <a href="mailto:info@skillwallah.com">info@skillwallah.com</a>. We aim to respond to all inquiries within [X] business days.</p>
            </div>
            <Component/>
            <Footer />
        </>
