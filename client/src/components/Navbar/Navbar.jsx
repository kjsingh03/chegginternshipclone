...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-center sm:justify-between px-2 py-2 border-b-4 border-[#EB7100] fixed w-full bg-white">
      <div className="flex items-center justify-between gap-3 sm:gap-5 py-3">
        <div className="w-[4rem] sm:w-[20rem] ">
