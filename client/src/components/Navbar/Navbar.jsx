...
const Navbar = () => {
  ...
  return (
    <div className="z-[1000] flex items-center justify-center sm:justify-between px-2 py-2 text-sm fixed w-full bg-white shadow-md text-[#080808]">
      <div className="flex items-center justify-between gap-3 sm:gap-5 ">
        <div className="w-[4rem] sm:w-[7rem] ">
