...
function Card({ data }) {
    ...
    return (
        <Link to={user ? `/internship/${data.id}` : "/login"} className="shadow-lg card w-[19rem] overflow-hidden hover:shadow-xl transition-all duration-150 ease-in flex flex-col justify-between p-8 gap-9 rounded-lg border border-[#EAECF0]">
